...
cvfun<-function(data, kernelFun, acquisition, leaveoutindex){
...
foreach(
  ...
  saveRDS(output,file=paste0("A_GeneratedFiles/modelfits/GM_fit_",x,".rds"))
}

fit<-readRDS(paste0("A_GeneratedFiles/modelfits/GM_fit_",10,".rds"))
