...
model_fit <- readRDS(paste0("A_GeneratedFiles/modelfits/GM_fit_",10))
...
modelSim(par = par, subjD=d1, acquisition=greedyMean, k=bayesianMeanTracker, rounds=rounds)
