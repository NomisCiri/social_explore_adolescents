...
Across all experimental treatments, adolescents and adults did not differ in points scored (two-sided t-test, t = `r round(t_test_points$statistic,2)`, df = `r round(t_test_points$parameter,2)`, p-value = `r round(t_test_points$p.value,2)`). Regression analysis (Figure 3a) shows that the quality of the advisor significantly impacted performance. Both adolescents and adults performed the best in high quality advisor rounds, while performance declined in the remaining treatments (medium quality: b = `r coef_points$medium$estimate`, C.I.= [`r coef_points$medium$ci_low`, `r coef_points$medium$ci_high`], BF = `r BFs_points[[2]]`; low quality: b = `r coef_points$low$estimate`, C.I.= [`r coef_points$low$ci_low`, `r coef_points$low$ci_high`], BF = `r BFs_points[[3]]`), indicating that worse social information led to fewer points gained. Finally, across all treatments there was no interaction effect between age group and advisor quality high_quality ado: [β = `r coef_points$adolescents$estimate`, C.I. = [`r coef_points$adolescents$ci_low`, `r coef_points$adolescents$ci_high`], BF = `r BFs_points[[1]]`], (age groupmedium quality: b = `r coef_points$ado_medium$estimate`, C.I. = [`r coef_points$ado_medium$ci_low`, `r coef_points$ado_medium$ci_high`], BF = `r BFs_points[[4]]`; age grouplow: b = `r coef_points$ado_low$estimate`, C.I. = [`r coef_points$ado_low$ci_low`, `r coef_points$ado_low$ci_high`], BF = `r BFs_points[[5]]`), suggesting that potential differences in social information use across treatments did not lead to differences in performance.
...
## extract coefficients from model object 
coef_gems <- summarize_model(gem_age_advisor_model, params_gems, names_gems, digits = 2)
