...
if (refit){
  ...
  #read from disk if refit is false
   social_fits_p<-read_csv(file = "A_GeneratedFiles/modelfits/kf_2p_greedy_social.csv")
}
...
write_csv(social_fits_p,file = "A_GeneratedFiles/modelfits/kf_2p_greedy_social.csv")
```
