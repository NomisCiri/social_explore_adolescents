...
model {
  ...
  for (ppt in 1:N){  
    for (r in 1:R_subj[ppt]){
      ...
      for (t in 1:T_max){
        //compute rewards with palminteris normalization rule. 
        //in Bavard, normalization is the first non0 outcome
        pe = (w[ppt,gem_found[t,r,ppt]]*(rewards[t,r,ppt]+50)/300 + (1-w[ppt,gem_found[t,r,ppt]])*rewards[t,r,ppt]) - belief_means[choices[t,r,ppt]];
        //update
