...
if (refit){
  ...
  social_fits <- foreach(
   ...
   # for (r in rounds) { # loop through rounds in roundList
    ...
    social_fits<- read_csv(file = "A_GeneratedFiles/modelfits/kf_sw_social_2greedy.csv")
}

write_csv(social_fits,file = "A_GeneratedFiles/modelfits/kf_sw_social_2greedy.csv")
```
