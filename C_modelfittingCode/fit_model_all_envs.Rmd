...
root=here()
source(paste0(root,"/C_modelfittingCode/models.R"))#more reproducible
```
...
explore_data = read_csv(file = paste0(root,"/Data/data_coord.csv"))
...
foreach(
  ...
  saveRDS(output,file=paste0("A_GeneratedFiles/modelfits/all_envs/GM_fit_New_Bounds_",playerNr,".rds"))
  }
