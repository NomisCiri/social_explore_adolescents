...
for (n in 1:length(unique(explore_data$player))) {
  ...
  one_player_old_bounds <-  readRDS(file = paste0("../A_GeneratedFiles/simulations/all_envs/simulated_choices", n))
  ...
  simd_data <- bind_rows(simd_data, one_player_old_bounds,one_player_new_bounds,one_player_free_prior)
}
